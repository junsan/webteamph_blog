    ...
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        @auth
          ...
          <a class="btn btn-sm btn-outline-secondary" style="border: none; margin-left: 5px;" href="{{ URL::route('logout') }}">Logout</a>
        @endauth
      </div>
    </div>
  </header>
    ...
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <div class="row g-5">
          ...
          <div class="col-md-5">
            <img src="public/images/{{ $moreblog->image }}" class="img-fluid" />
          </div>
        </div>
      </article>
      @endforeach
